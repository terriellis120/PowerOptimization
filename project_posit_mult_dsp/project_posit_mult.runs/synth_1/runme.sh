...
HD_PWD='C:/project_posit_mult_dsp/project_posit_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log posit_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source posit_mult.tcl
