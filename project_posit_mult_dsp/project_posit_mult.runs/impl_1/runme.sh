...
HD_PWD='C:/project_posit_mult_dsp/project_posit_mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log posit_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source posit_mult.tcl -notrace
